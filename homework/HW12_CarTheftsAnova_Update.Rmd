...
**Calculating the rates by period shows a clear spike year of car thefts in 2023. Then there is a slight decline in thefts. This suggest that thefts could continue to decline.**: The median rate nearly tripled from the 22.2 in the pre-spike to 58.1 in the spike year but the sample sizes varied a great deal, with 71 observations in pre-spike versus 12 in the spike year.
...
**Car thefts are relatively study from 2018-2022 until a spike in 2023 then there is a clear decline after the spike. A title could be: Car Thefts spike in 2023 then ease, but rates still remain above pre-spike**
...
- **Null Hypothesis (H0)**:   H0:μPre-spike=μSpike year=μPost-spike

- **Alternative Hypothesis (H1)**: H1:At least one μ is different
...
**The p-value is very small and is less than .001 so that means the result is significant. The anova shows a statistically significant difference among the means between time periods.**
...
**There are significant differences between all three time periods and it is real and significant between pre-spike and post-spike. 
Headline: Car Thefts spike in 2023 then ease, but rates still remain above pre-spike.
A statistical analysis of monthly car thefts from 2017-2025 reveals a spike in 2023. Although car thefts have begun to drop after 2023 they have still not returned to the pre-spike levels.**