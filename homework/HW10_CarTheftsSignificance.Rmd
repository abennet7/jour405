...
**I actually didn't expect the trend to be downward. I have heard more about car thefts recently so I thought it was becoming a bigger problem.**
...
- What does the 95% confidence interval show here? **The 95% confidence interval shows a range of numbers that we are 95% confident that the mean falls in.**

- What figure(s) accurately reflects the number of car thefts in a typical month? **The mean would most accurate depict the number of car thefts in a typical month with possible values falling under the numbers that 95% confidence interval encompasses. **

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. **Car theft has declined over the years based on data examining monthly car thefts.**
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **The p-value is less than .05 so we can reject the null hypothesis. The difference is statistically significant.**

How would you revise your headline from Task 6, if at all? What would you tell your editor, and what would you expect her to ask you? **No I would not revise because this further proves that car thefts are going down. I would expect her to ask more detailed questions like what percent have they gone down or something similar to that.**
