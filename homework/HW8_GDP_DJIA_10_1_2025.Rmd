...
GDP_Data |> 
  ...
  labs(title="Correlation between the DJIA and GDP", x= "DJIA", y = "GDP") 
```
...
There is a strong positive relationship between the DJIA and GDP. The scatterplot features points that form almost a straight line going to the upper right corner. There is only a few that do not fall exactly in the line, but it does still showcase a strong positive relationship. 
