...
**There are many factors that can contribute to education levels in survey samples differing, the main one could be response bias. People with higher education levels may be more likely to respond. Also if the survey is only online that limits the people who may be able to respond as people with a higher education may have different access to technology devices.**
...
**College educated people are more likely to vote over those with high school education or less.**
...
**The education group that showed the largest change is "high school or less" This group's yes percentage dropped by about 3%. The other two groups showed a less significant change with the yes percentage for the "college" category raising by .06% and the yes percentage for "some college" category dropping by .68%. **

2. Why might the weighted results be considered more accurate than the unweighted results?

**Since weights correct over or under representation they could be considered more accurate than the unweighted results.**
...
**It is important for journalists to understand weighting because that affects what the poll actually means.**

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**You could consider reporting the weighted data when reporting to a broader population, but you should disclose that it is weighted and not the exact results. **
...
**What was the weighting method? Did the weight significantly change the results? What was the source of the population benchmarks?**
