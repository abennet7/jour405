...
**Baltimore, Columbia, and Germantown stand out as diverse to me.**
...
**The city with the highest race probability, probability that two people randomly selected will be of the same race, is Summerfield. I believe this is because there is a 93% black population.**
...
**Chillum is the city with the lowest hispanic probability score. This city also has a high percentage of Black people.**
...
**The top three diverse cities are Langley Park, Wheaton, and Adelphi. Adelphi and Langley Park are both located in Prince George's County. Wheaton is in montgomery county. The least diverse is Lake Shore which is located in Anne Arundel County.**
...
**Maryland suburbs are now more diverse than larger cities.

I would talk to residents of the cities that have higher diversity values and ask them their opinions on it. The story would focus on benefits of living in a diverse community and how residents feel about that. **
