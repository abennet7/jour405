...
**Task 3: Private college mean SAT scores are significantly higher than community and public colleges. Public colleges are second in the ranking of mean SAT scores. There is a 75 point gap between private and public. Community colleges have the lowest mean SAT scores with a 367 point gap between the highest and 292 point gap between the second..**
...
1. Yes there is a significant different in SAT scores. The most significant different is public-private.
2. Private and community differ. Public and community differ. Public and private differ.
3. Private - Community has a 366 difference. Public - Community has a 292 difference. Public - Private has a -74 difference.