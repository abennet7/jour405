...
**Your answer**: Household income. Different states have instances when there a group of people making significantly more or less than the average person in that state so that would make it trail off to one side and skewe the data. Medal counts for countries in the Olympics. Certain countries have significantly more medals than other countries, the United States for example, which is signifcantly more than the average number of olympic medals.   
...
**Answer**:
Maryland is in the 95th percentile of total aces. 5% of other teams are higher. They are also ranked #17 out of 343 teams. 
...
The data is skewed left.  One standard deviation away from the mean has 3/4 of the data. 
