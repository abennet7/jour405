...
**There is a weak positive relationship between FARMS percentage and math test scores**
...
**Although the model is statistically significant, because it shows such a weak positive relationship it isn't necessarily worth using.**
...
**The largest difference between predicted and actual math scores is 34.89**
...
**The model doesn't show that fewer students on FARMS do better, if anything there is a weak sign in the opposite direction. The story would focus on debunking false statements from the board member and how statistically there is a weak correlation to begin with.**
